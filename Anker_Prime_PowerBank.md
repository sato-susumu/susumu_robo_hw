...
- [Raspberry Pi 5](検討中/RaspberryPi5_USB_PD_Power.md) 等のUSB-PD機器への給電
...
> **関連**: 別系統の電源検討として [24V系電源 (LiTime)](検討中/LiTime_24V_LiFePO4.md) 、Kit標準電源は [Battery.md](Battery.md) を参照。
